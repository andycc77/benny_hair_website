...
<div id="content">
        <div class="box themed_box fl width90">
            ...
            <form name="webform" action="<?=site_url("/album_add/add")?>" method="post">
                ...
                <table class="tablebox">
                    ...
                    <tbody class="table-data">
                        <tr>
                            ...
                            <td class="tt odd"  width="40%"><input type="text" name="desc" id="desc" value="" class="form-field half"></td>
                        </tr>
                        <tr>
                            ...
                            <td class="tt even" width="10%">下架時間</td>
                            <td class="tt odd"  width="40%"><input class="form-field datepicker" name="time_to" id="time_to" type="text" value="<?=date("m/d/Y" , time());?>" /></td>
                        </tr>
                        <tr>
                            <td width="10%" class="even">置頂</td>
                            <td width="40%" class="odd"><input type="checkbox" id="top" name="top"  value="" /></td>
                            <td class="tt even" width="10%"></td>
                            <td class="tt odd"  width="40%"></td>
                        </tr>
                        <tr>
                            <td width="10%" class="even">精選作品</td>
                            <td width="40%" class="odd"><a href="javascript:;" class="button white addlink" onclick="addones(this , 'Hpic');" ><span class="icon_text pack _457"></span>上傳圖片 900 * 630</a>
                            ...
                            <td class="tt odd"  width="40%"><a href="javascript:;" class="button white addlink" onclick="addones(this , 'Lpic');" ><span class="icon_text pack _457"></span>上傳圖片 940 * 630</a>
                                <ul id="ul_Lpic" class="clearfix">
                                    <?php if($r['Lpic'] != ""){ foreach(${$cms_ones} as $key => $val){ ?>
                                    <li class="clearfix">
                                        <img src="<?=$folder.${$cms_ones}[$key];?>" class="borimg" />
                                        <p class="actbtn"><a href="javascript:;" class="button white delone" onclick="delmeandshowaddlink(this);"><span class="packcolor _462"></span></a></p>
                                        <input type="hidden" name="<?=$bef.$cms_ones;?>[]" value="<?=$val;?>" />
