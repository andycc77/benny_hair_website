...
<div id="content">
        <div class="box themed_box fl width90">
            ...
            <form name="webform" action="<?=site_url("/blog_list/update/{$data['ArticleID']}")?>" method="post">
                ...
                <table class="tablebox">
                    ...
                    <tbody class="table-data">
                        <tr>
                            ...
                            <td width="40%" class="odd"><input type="text" name="name" id="name" value="<?php echo $data['Title']?>" class="form-field half"></td>
                        ...
                        <tr>
                            ...
                            <td width="40%" class="odd"><input class="form-field datepicker" name="time_from" id="time_from" type="text" value="<?= isset($data['Time'])?date("m/d/Y" , $data['Time']):date("m/d/Y" , time());?>" /></td>
                            <td class="tt even" width="10%">文章圖片</td>
                            <td class="tt odd"  width="40%"><a href="javascript:;" class="button white addlink <?=($data['Pic'] != "")?"uclose":"";?>" onclick="addones(this , 'Hpic');" ><span class="icon_text pack _457"></span>上傳圖片 940 * 630</a>
                                <ul id="ul_Hpic" class="clearfix">
                                    <?php if($data['Pic'] != ""){ ?>
                                    <li class="clearfix">
                                        <img src="<?php echo base_url('public/upload/tmp/').'/'.$data['Pic']?>" class="borimg" width="50%"/>
                                        <p class="actbtn"><a href="javascript:;" class="button white delone" onclick="delmeandshowaddlink(this);"><span class="packcolor _462"></span></a></p>
                                      <input type="hidden" name="Hpic" value="<?php echo $data['Pic']?>" />
                                    </li>
                                    <?php  } ?>
                                </ul></td>
                        </tr>
                        <tr>
                            ...
                            <td width="40%" class="odd"><input type="checkbox" id="top" name="top" <?=($data['articleOrder'] == "1")?"checked":"";?> value="<?php echo $data['articleOrder']?>" /></td>
                            <td class="tt even" width="10%"></td>
                            <td class="tt odd"  width="40%"></td>
                        </tr>
                        <tr>
                            <td width="10%" class="even">內容</td>
                            <td width="40%" class="odd" colspan="3"> <textarea name="main" class="ckeditor" id="main" cols="50" rows="20"><?php echo $data['Content']?></textarea>
                             <script type="text/javascript">
