...
?>
	<?php if (isset($result)){ //判斷上傳結果
		$url = $_POST['upFloder']."/".$file_name;
		$sql = "update header set url ='".$url."' , name = '".$file_name."' where sno='".$_POST['sno']."'";
		mysql_query($sql);
		?>
        <script language = "javascript">
            window.opener.document.getElementById("<?php echo $_POST['prevImg']; ?>").src = '<?php echo $_SESSION['upload_folder']?>/'+'<?php echo $_POST['upFloder']."/" ?>'+'<?php echo $file_name; ?>';
