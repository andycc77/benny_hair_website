<?php //中
	...
	$mylps = 		array("{$bef}Sno"=>"",
						  ...
						  "{$bef}Main"=>"Email 內容",
						  "{$bef}Note"=>"<ul>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$admId}</a> : 管理員ID</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$admPw}</a> : 新密碼</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$admNick}</a> : 管理員暱稱</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$admEmail}</a> : 管理員Email</li>
						  </ul>"
						  );
	//Search Descriptions
	$mylse = 		array("{$bef}Sno"=>"",
