...
"{$bef}Main"=>"Email 內容",
"{$bef}Note"=>"<ul>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$adpName}</a> : 公司名</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$adpTax}</a> : 統編</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$adpAddress}</a> : 地址</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$adpUrl}</a> : 廠商管理員驗證網址</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$adpMsg}</a> : 邀請留言</li>
</ul>"
);
//Search Descriptions
$mylse = array("{$bef}Sno"=>"",
