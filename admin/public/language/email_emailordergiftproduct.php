...
"{$bef}Main"=>"Email 內容",
"{$bef}Note"=>"<ul>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$orpSno}</a> : 訂單號碼</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$memSno}</a> : 會員名稱</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$gipTitle}</a> : 兌換內容</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$orpBonus}</a> : 使用點數</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$orpForm}</a> : 資料</li>
<li><a href='javascript:;' class='button white' onclick='addme(this);'>{\$orpTime}</a> : 時間</li>
