...
class Comments_list extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->data['subview'] = 'comments/comments_list';
    ...
    public function readcount(){
        $this->load->model("CommentsModel");
        $result = $this->CommentsModel->getReadcount();
        $json['result'] = $result;
        echo json_encode($json);
    }
    ...
    public function notreadcount(){
        $this->load->model("CommentsModel");
        $result = $this->CommentsModel->getNotreadcount();
        $json['result'] = $result;
        echo json_encode($json);
    }
}