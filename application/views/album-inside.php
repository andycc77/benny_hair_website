...
<div class="pi-text-center pi-margin-bottom-50">
    <h3 class="pi-uppercase pi-weight-700 pi-has-border pi-has-tall-border pi-has-short-border">
        <?php echo $data['album']['Name']?>
    </h3>
    <p>
         <?php echo $data['album']['Desc']?>
    </p>
</div>
...
<?php foreach ($data['pic'] as $key => $val) {?>
    ...
    <div class="Photography pi-col-sm-4 pi-col-xs-6 isotope-item">
        <div class="pi-img-w pi-img-hover-zoom">
            <img src="<?php echo base_url('admin/public/upload/album_pic/').'/'.$val['Name'];?>" alt="">
            <div class="pi-img-overlay pi-img-overlay-darker">
                <div class="pi-caption-centered">
                    <div>
                        <a href="<?php echo base_url('admin/public/upload/album_pic/').'/'.$val['Name'];?>" class="pi-colorbox">
                            <span class="pi-caption-icon pi-caption-scale icon-search"></span>
                        </a>
                        <!--<h3 class="h4 pi-weight-300"><a href="<?php echo base_url('admin/public/upload/album_pic/').'/'.$val['Name'];?>" class="pi-link-white"><?php echo $val['Name']?></a></h3>-->
                        <!--<ul class="pi-caption-links">
                            <li><i class="icon-tag"></i><a href="#"></a></li>
                            <li><i class="icon-user"></i><a href="http://ineedchemicalx.deviantart.com/art/The-Sunset-457814598">admin</a></li>
                        </ul>-->
                    </div>
                </div>
            </div>
