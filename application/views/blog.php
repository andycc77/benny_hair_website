            ...
            <div id="pi-mobile-menu-8" class="pi-section-menu-mobile-w pi-section-dark">
                <div class="pi-section-menu-mobile">
                    ...
                    <ul class="pi-menu-mobile pi-menu-mobile-dark">
                        <li class="active"><a href="<?site_url("/welcome") ?>">首頁</a></li>
                        <li>
...
$Title = textLimit($val['Title'],30);
$Content = explode('<hr>',$val['Content']);
//$content = preg_replace('/ <hr>\.$/', '', $val['Content']);
    ...
    <div class="pi-col-sm-4 pi-col-xs-6 isotope-item">
        <div class="pi-portfolio-item pi-portfolio-description-box pi-portfolio-item-round-corners">
            ...
            <div class="pi-img-w pi-img-round-corners pi-img-hover-zoom">
                <!--<a href="<?php echo base_url('admin/public/upload/tmp')?>/<?php echo $val['Pic']?>" class="pi-colorbox cboxElement">-->
                <a href="<?php echo site_url('/bloginside/index')?>/<?php echo $val['ArticleID']?>" class="cboxElement">
            ...
            <div class="pi-portfolio-description pi-portfolio-description-round-corners">
                ...
                <h2 class="h4"><a href="<?php echo site_url('/bloginside/index')?>/<?php echo $val['ArticleID']?>" class="pi-link-no-style"><?php echo $Title?></a>
                </h2>
